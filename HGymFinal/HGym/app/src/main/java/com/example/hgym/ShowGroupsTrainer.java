...
//intent for showing the groups that the trainer trains.
public class ShowGroupsTrainer extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_groups_trainer);
    ...
    //loading the groups of the trainer.
        ...
        audioColl.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                for( QueryDocumentSnapshot documentSnapshot: queryDocumentSnapshots){
                    ...
                    Log.d(Integer.parseInt(g.getDate().substring(3,5))+"","month");
                    if(Integer.parseInt(g.getDate().substring(6)) >= currentTime.getYear()){
                        if(Integer.parseInt(g.getDate().substring(3,5)) >= currentTime.getMonth() || Integer.parseInt(g.getDate().substring(6)) > currentTime.getYear()){
                            if(Integer.parseInt(g.getDate().substring(0,2)) >= Integer.parseInt((currentTime).toString().substring(8,10)) || Integer.parseInt(g.getDate().substring(3,5)) > currentTime.getMonth()|| Integer.parseInt(g.getDate().substring(6)) > currentTime.getYear()){
                                Log.d("month",Integer.parseInt(g.getDate().substring(3,5))+"");
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        else
                        {
                            ...
                            Toast.makeText(ShowGroupsTrainer.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ShowGroupsTrainer.this, "Fail to load data..", Toast.LENGTH_SHORT).show();
                    }
                });
        ArrayList<group> methods = new ArrayList<>();
        ...
        if(id == R.id.menu_logOut)
        {
            ...
            builder.setPositiveButton("yes", new DialogInterface.OnClickListener()
            {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent intent = new Intent(ShowGroupsTrainer.this, LogInActivity.class);
                    startActivity(intent);
                }
            });
