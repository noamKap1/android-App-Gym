...
//intent that shows the menu for a trainer.
public class MainActivityTrainer extends AppCompatActivity implements View.OnClickListener {
    //AudioRecordActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_showExercises) {
            ...
            builder.setNegativeButton("no", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    Toast.makeText(MainActivityTrainer.this, "canceled", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        if(id == R.id.menu_logOut)
        {
            ...
            builder.setPositiveButton("yes", new DialogInterface.OnClickListener()
            {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent intent = new Intent(MainActivityTrainer.this, LogInActivity.class);
                    startActivity(intent);
                }
            });
            builder.setNegativeButton("no", new DialogInterface.OnClickListener() {
    ...
    //going to the list view activity, shows the same personal with the same roll.
